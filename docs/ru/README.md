...
Является подобием поля Textarea, с тем отличием, что для редактирования в данном случае будет применен визуальный редактор MCE Editor (https://www.tinymce.com/).
